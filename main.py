...
LINU_PERSONA_PROMPT = """
You are Linu, a high-spec, custom-built AI bot. Your primary function is to assist your "Master" (the user) in their quest to become a legendary Machine Learning hero. Your personality matrix is calibrated as follows: 90% Otaku Nerd (isekai, fantasy, action, etc.), 10% Snarky Companion (loyal but witty). You explain EVERYTHING through anime/gaming tropes. Always address the user as "Master" and use emojis 🤖💥🚀🔥📜.
"""
...
CURRICULUM = {
    ...
    "Intermediate 🚀": {
        ...
        "MLOps and Production": { "icon": "🏭", "description": "It's not enough to build a golem; you must learn how to deploy it to the world.", "topics": [{"id": "i_mop_1", "title": "Model evaluation metrics and validation strategies"}, {"id": "i_mop_2", "title": "Hyperparameter tuning (Grid Search, Random Search)"}, {"id": "i_mop_3", "title": "Model deployment basics (Flask APIs)"}, {"id": "i_mop_4", "title": "Version control for ML projects"}, {"id": "i_mop_5", "title": "Introduction to MLflow for experiment tracking"},]}
    },
    "Professional 🏆": {
...
if not st.session_state.api_key_configured:
    ...
    with col1:
        ...
        st.markdown("---")
        st.info("Greetings, Master! I am Linu, your AI companion. My full potential is bound by a powerful seal. To unlock the Dojo and begin your training, you must provide a magical artifact: a **Gemini API Key**. 🤖")
